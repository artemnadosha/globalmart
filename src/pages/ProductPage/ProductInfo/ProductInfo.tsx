...
const ProductInfo: FC<ProductInfoProps> = ({ product }) => {
    ...
    const { setBasketItem, basketItem } = useContextStore();
    ...
    const handlerAddProductBasket = () => {
        if (!basketItem?.find(item => item.id === product.id)) {
            if (setBasketItem) {
    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.wrapperImages}>
                ...
                <div className={styles.wrapperSubImages}>{images.map(item => <div key={item}
                                                                                  className={styles.wrapperSubImage}>
                    <img
            ...
            <div className={styles.wrapperInfo}>
                <div>
                    ...
                    <div className={styles.wrapperButton}>
                        <Button style={enumButton.SUBMIT}>Buy Now</Button>
                        <Button style={enumButton.PRIMARY} onClick={handlerAddProductBasket}>Add to cart</Button>
                    </div>
                </div>
