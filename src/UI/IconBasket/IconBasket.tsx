...
import styles from './IconBasket.module.scss'
...
const IconBasket: FC<IconBasketProps> = ({withText, onClick, countLiked, activeIcon}) => {
    ...
    return (
        <div className={cn(styles.basket, activeIcon && styles.active)} onClick={handleClick}>
            <svg width="30" height="29" viewBox="0 0 22 21" fill="none"
